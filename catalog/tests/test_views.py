...
class AuthorListViewTest(TestCase):
    ...
    def setUpTestData(cls):
        ...
        for author_num in range(number_of_authors):
            Author.objects.create(first_name='First %s' % author_num, last_name='Last %s' % author_num)
...
class LoanedBookInstanceByUserListViewTest(TestCase):
    ...
    def setUp(self):
        ...
        # Create a book
        test_author = Author.objects.create(first_name='John', last_name='Han')
        test_genre = Genre.objects.create(name='Fantasy')
        test_language = Language.objects.create(name='English')
        test_book = Book.objects.create(title='Book Title', summary='Summary', isbn='ABCD', author=test_author, language=test_language)
